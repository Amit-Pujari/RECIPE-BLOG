...
export default function RecipeDetails() {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const res = await axios.post(`http://44.213.70.106:5000/recipe/${id}/comments`, { text: newReview })
   ...
   <>
    <div className='outer-container'>
        ...
        <img src={`http://44.213.70.106:5000/images/${recipe.coverImage}`} width="220px" height="200px"></img>
